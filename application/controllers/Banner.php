...
class Banner extends CI_Controller {
	...
	public function add()
	{
		...
		$this->form_validation->set_rules('content', 'Content banner', 'required',[
			'required' => 'Deskripsi banner wajib diisi.',
		]);
		...
		if($this->form_validation->run() == false) {
			...
			$this->session->set_flashdata('success', 'Banner berhasil di tambahkan');
	...
	public function edit($id) {
		...
		if($this->form_validation->run() == false) {
			...
			$this->session->set_flashdata('success', 'Banner berhasil di ubah.');
	...
	public function delete($id) {
		...
		$this->session->set_flashdata('success', 'Banner berhasil di hapus.');
