<div class="container">
	...
	<div class="row mt-5">		
		...
		<div class="col-5">
			...
			<a href="#description" class="text-info font-weight-bold">Selengkapnya</a>
			<br> <br>
			...
			<div class="card">
				<div class="card-body text-center">
					...
					<form action="<?= base_url('cart/add') ?>" method="POST">
						...
						<button type="submit" class="btn btn-large btn-success btn-block badge-pill mb-4">Masukan Keranjang</button>
					</form>
				</div>
			</div>
		</div>
	...
	<div class="row mt-5 mb-2">
		<div class="col">
			<h3 id="description">Deskripsi Produk</h3>
		</div>
	</div>
